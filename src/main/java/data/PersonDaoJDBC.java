...
public class PersonDaoJDBC { //DAO: Data Access Object
    ...
    public PersonDaoJDBC(Connection transaccConnection) {
    ...
    public List<PersonDTO> select() throws SQLException {
        ...
        try {
            ...
            while (result.next()) {
                ...
                person = new PersonDTO(personID, personName, personLastname, personEmail, personPhone);
                persons.add(person);
            }
